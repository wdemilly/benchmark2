...
def generate_quality_gated_batch(
    ...
    """Generate drafts into fixed slots, keep only drafts tied at the top
    prose-quality score, and refill discarded slots until the requested batch
    size is complete or the try cap is hit."""
    ...
    while round_no < max_tries:
        ...
        for slot in slots:
            ...
            elif quality_by_run.get(rid, {}).get("verdict") == "UNACCEPTABLE":
