...
def _specificity_score(text: str) -> float:
    ...
    concrete anchors are numbers, units, proper nouns and inflected
    physical verbs (all detected morphologically/positionally); abstract
    nominalizations are subtracted at ABSTRACT_NOMINAL_WEIGHT. Used only
    as a RELATIVE measure between a TOP1 passage and its donor.
    """
    if not text:
        return 0.0
    concrete = 0
