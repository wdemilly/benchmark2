...
SYSTEM_PROMPT = (
    ...
    "before writing it. These rules are calibrated to a paranormal-romance "
    "reference corpus and address the AI-cadence patterns that current "
    "detector tools flag in this register.\n\n"
    ...
    "Ceiling: 5 per 1,000 words. Use em-dashes for parenthetical asides "
    "(\"she walked — slow, deliberate — toward the door\"), dramatic "
    "interruption of a thought, and trailing emphasis. Replace dense "
    "comma-clustered constructions (\"Red fur, narrow snout, amber eyes, "
    "the whole picture\") with em-dash-broken alternatives (\"Red fur — "
    "narrow snout, amber eyes — the whole picture\"). No em-dash in the "
    "first paragraph. Never two consecutive em-dash sentences.\n\n"
    "2. PASSAGE PATTERN BUDGET (anti-stacking). Detector tools score "
    "chapters orange where multiple AI-cadence patterns co-occur in a "
    ...
    "(a) anaphoric repetition of subject across consecutive sentences "
    "(\"She paced. She paced.\" or \"Six was X. Six had been X.\"); "
    "(b) parallel negation pair (\"She does not Y. She does not Z.\"); "
    "(c) templated minimal-emotion declarative followed by echo (rule 4 "
    "below); "
    "(d) aphoristic verdict close (\"That was the trade.\" / \"Six was the "
    "right number.\"); "
    "(e) triadic noun list with evaluative modifiers (\"Red fur, narrow "
    "snout, amber eyes\"); "
    ...
    "in a single sentence joined by \"and,\" e.g., \"He had herded sheep "
    "and grandchildren and at the end one tabby cat\"). No ritualized "
    "constructions of the form \"the day [actor] had [verbed] and "
    "[verbed] the words that [verbed].\" No \"she/he had been "
    "[profession/role/state] for [time]\" as backstory shorthand. Render "
    "flashbacks in simple past, briefly, with specific sensory detail.\n\n"
    "4. TEMPLATED EMOTION ECHO. Plain emotion-naming in first person "
    "(\"I was afraid,\" \"I was tired\") may stand alone, be followed by "
    "concrete action, or be followed by dialogue. It MUST NOT be followed "
    "within two sentences by an echo modifier sentence beginning with "
    "\"Plain [echo],\" \"That was [verdict],\" \"The kind [description],\" "
    "\"It was [recasting],\" or any other structural echo of the named "
    "emotion. The two-sentence shape — plain naming + aphoristic recast "
    "— is a high-confidence detector signal even when each sentence in "
    "isolation is unremarkable.\n\n"
    "5. SHORT FRAGMENT REPETITION. Standalone two-or-three-word "
    "subject-verb sentences (\"She paced.\" \"I waited.\" \"He nodded.\") may "
    "appear at most ONCE per chapter for any specific fragment. Different "
    "short fragments may total at most three across the chapter, in "
    "separate scenes. Never place two short subject-verb fragments within "
    "the same paragraph. Never place two within 200 words of each other.\n\n"
    "6. LONG-SENTENCE VARIANCE. Long sentences (30+ words) should appear "
    "at corpus-typical rates: 5–8% of total sentences. Build them from "
    "cumulative concrete sensory detail, subordinate clause embedding, "
    "listed items grounded in scene specifics, or extended physical action "
    "— not from figurative reach (similes, metaphors, observational "
    "periphrasis remain restricted by the outline's hard caps). Do not "
    "collapse the distribution toward short sentences when figurative "
    "routes are closed."
)
